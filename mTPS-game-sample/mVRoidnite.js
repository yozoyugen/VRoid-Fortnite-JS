...
function game() {
    ...
    let playerCapsuleH = playerRadius*3; //playerRadius*3;
  ...
  /*  //let line_geo = new THREE.LineSegmentsGeometry();
    ...
    function mCreateFiringMesh(vertices){
        ...
        const radius = 0.01; // Example radius
    ...
    function mSetEditShape(build){
        ...
        if(build.buildType==0){
            ...
            //build.buildMesh = null;
            //build.buildMesh = new THREE.Mesh(new THREE.BoxGeometry(grid_size, gridH_size/2, buildThick), new THREE.MeshBasicMaterial({color: "brown"}))
            //let mesh = new THREE.Mesh(new THREE.BoxGeometry(grid_size, gridH_size/2, buildThick), new THREE.MeshBasicMaterial({color: "brown"}));
    ...
    function mCreateWallEditCollider(build){
        ...
        let editType = build.editType;
        let dirType = build.dirType;
